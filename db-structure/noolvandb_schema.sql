...
-- Mobile agent: FCM device registration + pull queue (see update_old_db_mobile_agent_fcm.sql)
CREATE TABLE public.agent_device_registrations (
...
CREATE INDEX idx_agent_device_registrations_device_id ON public.agent_device_registrations (device_id);
CREATE INDEX idx_agent_device_registrations_company_id ON public.agent_device_registrations (company_id);
...
CREATE INDEX idx_agent_pending_tasks_user_device ON public.agent_pending_tasks (user_id, device_id, created_at);
